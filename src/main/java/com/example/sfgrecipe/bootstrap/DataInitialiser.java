package com.example.sfgrecipe.bootstrap;

import com.example.sfgrecipe.model.*;
...
public class DataInitialiser implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public DataInitialiser(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("news.bbc.co.uk");
        ...
        tacosRecipe.setUrl("elconfidential.com");
